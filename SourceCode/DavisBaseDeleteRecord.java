...
// Description :Deleting record in the table
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {	
        ...
        try
        {
            ...
            else if(deleteString.contains(">="))
            {
                String id = deleteString.substring(deleteString.lastIndexOf('=') + 1, deleteString.length() ).trim();
                int rowid = Integer.parseInt(id);
                int maxId = DavisBaseDropTable.get_row_id(tableFile, (int) (tableFile.length()/DavisBasePrompt.pageSize -1));
                if(maxId <= rowid)
                {
                    return;
                }
            ...
            for(int i =0; i<numPages; i++)
            {
                ...
                for(short j =0; j<numRecs; j++)
                {
                    ...
                    if(rowid == recId)
                    {
                        ...
                        DavisBaseDropTable.decrement_records(j,numRecs,i,tableFile);
                        ...
                        DavisBaseDropTable.change_recent_pointer(i,tableFile);
                        break;
                    }
                    if(found == true){
                    	break;}
